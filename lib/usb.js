...
var { usb, getDeviceList, findByIds }  = require('usb');
...
BluetoothHciSocket.prototype.bindUser = function(devId, params) {
  ...
  if (!this._usbDevice) {
    throw new Error('No compatible USB Bluetooth device found!');
  }
